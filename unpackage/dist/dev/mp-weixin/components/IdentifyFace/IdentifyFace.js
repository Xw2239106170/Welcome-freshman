...
/* harmony import */ var _IdentifyFace_vue_vue_type_template_id_7ee47824___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./IdentifyFace.vue?vue&type=template&id=7ee47824& */ 234);
/* harmony import */ var _IdentifyFace_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./IdentifyFace.vue?vue&type=script&lang=js& */ 236);
...
/* harmony import */ var _IdentifyFace_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./IdentifyFace.vue?vue&type=style&index=0&lang=scss& */ 238);
...
var _default = {
  name: "IdentifyFace",
  computed: _objectSpread({}, (0, _vuex.mapState)('user', ['faceImage', 'userPhoto'])),
  data: function data() {
    return {
  ...
  methods: _objectSpread(_objectSpread({}, (0, _vuex.mapMutations)('user', ['getFaceImage', 'getUserPhoto'])), {}, {
    judgePerson: function judgePerson(image) {
      var _this = this;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                csc = _context.sent;
                return _context.abrupt("return", csc);
              case 4:
              case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", uni.$showMsg('请勾选阅读协议！'));
              case 2:
                _this2.cameraContext.takePhoto({
                  quality: 'high',
                  success: function success(res) {
                    ...
                    // 上传图片
                    wx.uploadFile({
                      url: 'http://192.168.14.54:8080/upload',
                      // 上传接口地址
                      ...
                      success: function success(res) {
                        ...
                        var responseString = "".concat(res.data);
                        var responseObject = JSON.parse(responseString);
                        this.img = responseObject.data;
                        // console.log('img' + this.img)
                        var csc = uni.$http.get('/stu', {
                          image1: this.img,
                          xuehao: '2212040252'
                        });
                        csc.then(function (data) {
                          var response = JSON.parse(data.data.data);
                          _this3.similarity = response.score;
                          if (_this3.similarity > 0.67) {
                            _this3.photo = _this3.img;
                            uni.setStorageSync('userPhoto', _this3.photo);
                            uni.navigateTo({
                ...
                _this2.getUserPhoto(_this2.photo);
  ...
  watch: {
    photo: function photo(newVal, oldVal) {
      // 在photo变化时执行逻辑
