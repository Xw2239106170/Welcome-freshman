  ...
  <view class="container">
    ...
    <view class="header">
      <view class="user-info">
        <text class="nickname">Hi, 小明同学</text>
        <text class="dept">计算机科学与技术 · 2024级</text>
      </view>
    </view>
    ...
    <view class="card">
      <view class="card-header">
        ...
        <view class="qr-wrapper" @tap="showQRCode">
          <image src="/static/icons/qr-code.png" mode="aspectFit" class="qr-icon"></image>
        </view>
      </view>
    ...
    data() {
      return {
        functions: [{
          ...
          {
            icon: '/static/icons/attendance.png',
            title: '考勤',
            desc: '上课打卡',
            bgColor: '#DCFCE7',
